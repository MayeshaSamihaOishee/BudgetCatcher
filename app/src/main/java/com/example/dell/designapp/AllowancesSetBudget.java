...
public class AllowancesSetBudget extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allowances_set_budget);
    }
    ...
    {
        Intent intent = new Intent(AllowancesSetBudget.this, BottomNavigationn.class);
